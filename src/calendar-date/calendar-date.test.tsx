...
describe("CalendarDate", () => {
  ...
  describe("a11y", () => {
    ...
    it("has a label for the group", async () => {
      ...
      await expect
        .element(heading)
        .toHaveTextContent(formatter.format(yearMonth));
    });
  ...
  describe("page by", () => {
    describe("months", () => {
      it("can page by months", async () => {
        ...
        await expect
          .element(getMonthHeading(first!))
          .toHaveTextContent("March");
        await expect
          .element(getMonthHeading(second!))
          .toHaveTextContent("April");
      });
      ...
      it("updates page as user navigates dates", async () => {
        ...
        await expect
          .element(getCalendarVisibleHeading(calendar))
  ...
  describe("localization", () => {
    it("localizes heading", async () => {
      ...
      await expect
        .element(getCalendarHeading(calendar))
        .toHaveTextContent("Januar 2020");

      await getNextPageButton(calendar).click();
      await expect
        .element(getCalendarHeading(calendar))
        .toHaveTextContent("Februar 2020");

      await getNextPageButton(calendar).click();
      await expect
        .element(getCalendarHeading(calendar))
        .toHaveTextContent("März 2020");

      await getNextPageButton(calendar).click();
      await expect
        .element(getCalendarHeading(calendar))
        .toHaveTextContent("April 2020");

      await getNextPageButton(calendar).click();
      await expect
        .element(getCalendarHeading(calendar))
        .toHaveTextContent("Mai 2020");

      await getNextPageButton(calendar).click();
      await expect
        .element(getCalendarHeading(calendar))
        .toHaveTextContent("Juni 2020");

      await getNextPageButton(calendar).click();
      await expect
        .element(getCalendarHeading(calendar))
        .toHaveTextContent("Juli 2020");

      await getNextPageButton(calendar).click();
      await expect
        .element(getCalendarHeading(calendar))
        .toHaveTextContent("August 2020");
      ...
      await expect
        .element(getCalendarHeading(calendar))
        .toHaveTextContent("Oktober 2020");

      await getNextPageButton(calendar).click();
      await expect
        .element(getCalendarHeading(calendar))
        .toHaveTextContent("November 2020");

      await getNextPageButton(calendar).click();
      await expect
        .element(getCalendarHeading(calendar))
        .toHaveTextContent("Dezember 2020");
    });
  });
